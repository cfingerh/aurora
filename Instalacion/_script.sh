...
sudo bash /opt/wildfly/bin/jboss-cli.sh --connect --controller=127.0.0.1:10000 --command="deploy --force /home/ubuntu/aurora/fuenteserv/SGDP/target/sgdp-0.0.1-SNAPSHOT.war "
